    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open} color=''>
        <Toolbar>
          ...
          <div className='topheaderdashboardmainbox'>
        ...
        <Menu
          ...
          items={[
            ...
            },
            {
              ...
              <path d="M2 4H4V10.5H2C1.44772 10.5 1 10.0523 1 9.5V5C1 4.44772 1.44772 4 2 4Z" fill="#E9E9EB" stroke="#4B4C5E" strokewidth="1.2"/>
              <path d="M7 11.5V18C7 18.8284 7.67157 19.5 8.5 19.5V19.5C9.32843 19.5 10 18.8284 10 18V16" stroke="#4B4C5E" strokeWidth="1.2"/>
              <path d="M21.7022 4.01334L19 3V12L21.8944 10.5528C22.572 10.214 23 9.52148 23 8.76393V5.886C23 5.05231 22.4829 4.30607 21.7022 4.01334Z" fill="#E9E9EB" stroke="#4B4C5E" strokewidth="1.2"/>
              <path d="M19.5 13.2092V2.21211C19.5 1.58359 18.927 1.1109 18.31 1.23033L4 4V10.5L18.2501 14.1775C18.8831 14.3408 19.5 13.8629 19.5 13.2092Z" fill="#E9E9EB" stroke="#4B4C5E" strokeWidth="1.2"/>
              </svg>
