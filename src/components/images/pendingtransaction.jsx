...
const Userstatistics = () => {
  ...
  const columns = [
  ...
  
    {
      ...
      dataIndex: 'email',
      width: '10%',
      render: () => {return <p style={{backgroundColor:'#3A6FF8' , border:'none' , borderRadius:'5px' , padding:'5px 10px' , color:'white' , fontFamily:'Rubik' , fontSize:'13px',textAlign:'center'}} >Pending</p>},
    },
  ];
