...
const Userstatistics = () => {
  ...
  const columns = [
  ...
  
    {
      ...
      dataIndex: 'email',
      width: '10%',
      render: () => {return <p style={{backgroundColor:'green',textAlign:'center' , border:'none' , borderRadius:'5px' , padding:'5px 10px' , color:'white' , fontFamily:'Rubik' , fontSize:'13px'}} >Completed</p>},
    },
  ];
...
<>
    <Form form={form} component={false}>
        <p className='addcreatorheading'> Complete Transaction</p>
      <Table
